...
case_id: QA-XXXX
generated_at: "REQUIRED:SYSTEM-TIMESTAMP"
source_revision: "REQUIRED:SYSTEM-REVISION"
recipient_role: "REQUIRED:HUMAN-INPUT:RECIPIENT-ROLE"
...
- QAケース: `QA-XXXX`
- 対象: `REQUIRED:HUMAN-INPUT:TARGET`
- 受け手の役割: `REQUIRED:HUMAN-INPUT:RECIPIENT-ROLE`
- 現在の状態: `draft`
...
- 生成元リビジョン: `REQUIRED:SYSTEM-REVISION`
