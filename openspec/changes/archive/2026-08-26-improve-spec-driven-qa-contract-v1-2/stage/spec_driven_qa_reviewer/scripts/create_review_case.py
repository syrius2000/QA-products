...
from spec_driven_qa_reviewer.scripts.common import git_revision, next_case_number, now_iso, slugify
...
def main() -> int:
    ...
    (case_dir / "handoff.md").write_text(
        render(case_dir, recipient_role="implementer", workflow="author-response"), encoding="utf-8"
    )
