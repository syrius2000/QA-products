...
The helper scripts require Python 3.10+ and use only the standard library at runtime. PyYAML is an optional development/test dependency for schema-oriented checks and is not required in the target project.
